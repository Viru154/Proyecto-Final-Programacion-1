...
public:
	...
	void ingresar() {
		...
		if (cn.getConectar()) {
			string insertar = "INSERT INTO `proyecto_final_programacion`.`empleados` (`nombres`,`apellidos`,`direccion`,`telefono`,`DPI`,`genero`,`fecha_nacimiento`,`idpuestos`,`fecha_inicio_labores`,`fechaingreso`) VALUES('"+nombres+"','"+apellidos+"','"+direccion+"','"+telefono+"','"+dpi+"','"+genero+"','"+fecha_nacimiento+"','"+idpuesto+"','"+fecha_inicio_labores+"','"+fechaingreso+"');";
